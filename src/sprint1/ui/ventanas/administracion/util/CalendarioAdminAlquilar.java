...
public class CalendarioAdminAlquilar extends JDialog {
	...
	private AdminAlquilaSocioDialog adminAlquilaWindow;
...
//	}
	...
	private CalendarioAdminAlquilar getMe() {
		return this;
	}

	private void openAdminAlquilaSocioWindow(CalendarioAdminAlquilar parent, int dia, int mes, int año) {
		adminAlquilaWindow = new AdminAlquilaSocioDialog(parent, dia, mes, año);
