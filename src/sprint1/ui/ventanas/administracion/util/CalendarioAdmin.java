...
import sprint1.ui.ventanas.administracion.actividades.PlanificarActividadDialog;
...
public class CalendarioAdmin extends Calendario {
	...
	private class AsignarActividades implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			int mes = fecha[1];
			int año = fecha[2];
			PlanificarActividadDialog aad = new PlanificarActividadDialog(getMe(), getPrograma(), dia, mes, año);
