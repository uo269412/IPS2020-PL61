...
public class EscogerConflictoAResolver extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public EscogerConflictoAResolver(CalendarioSemanalModificar parent, List<ActividadPlanificada> actividades) {
			...
			list.addMouseListener(new MouseAdapter() {
			    public void mouseClicked(MouseEvent evt) {
			        ...
			        if (evt.getClickCount() == 2) {
			            ...
			            ModificarPlanificacionDialog mcad = new ModificarPlanificacionDialog(parent, ap);
